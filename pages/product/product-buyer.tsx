...
const ProductBuyer: NextPage = () => {
    return (
        <>
            <
                SectionWrapper className="lg:flex lg:flex-row lg:justify-center bg-vector-1 bg-no-repeat bg-left-5 bg-contain"
            >
                <div className="flex flex-col items-center lg:mx-10 lg:items-start">
                    ...
                    <ItemWrapper className="mt-5 text-center lg:text-left">
                        <p>Vytvářejte objednávky a sledujte jejich stav na jednom místě.</p>
                    </ItemWrapper>
                    <ItemMargin>
                        <Button text="Registrovat se jako obchod" link="https://app.colabu.cz/register"/>
                    </ItemMargin>
                </div>
